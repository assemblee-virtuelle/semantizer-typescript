...
export interface DocumentFactory {
    ...
    createDocumentReadonly<ContainedThing extends ThingReadonly = ThingReadonly, SelfDescribingThing extends ThingReadonly = ThingReadonly>(uri?: string, context?: Context): DocumentReadonly<ContainedThing, SelfDescribingThing>;
}
