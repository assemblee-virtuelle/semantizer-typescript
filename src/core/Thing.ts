...
export type ThingConstructor<
    ThingType extends Thing<any> = Thing
...
export interface Thing<
    StatementType extends Statement = Statement
> extends Resource, /*ResourceCollection<ContainedStatement>,*/ WithContext, Comparable, Copyable 
{
...
export type ThingWritable<
    StatementType extends Statement = Statement
> = Thing<StatementType> & ThingWithWriteOperations<StatementType>;