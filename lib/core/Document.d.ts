...
export interface WithFactoryForCopying<DocumentType extends Document<any, any> | DocumentReadonly<any, any>> {
...
export interface WithCopyWritableOperations<DocumentResulting extends DocumentBase<any, any>> {
