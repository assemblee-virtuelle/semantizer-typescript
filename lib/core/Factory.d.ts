...
export interface Factory<DocumentType extends Document<any, any, any, any>> {
...
export interface FactoryForCopying<InputDocument extends DocumentBase<any, any>, OutputDocument extends DocumentBase<any, any>> {
