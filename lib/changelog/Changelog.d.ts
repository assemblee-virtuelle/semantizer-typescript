...
export interface ChangelogNonDestructiveOperations<StatementType extends Statement = Statement> {
    getAdded(): StatementType[];
    getUpdated(): StatementType[];
    getDeleted(): StatementType[];
}
export interface ChangelogDestructiveOperations<StatementType extends Statement = Statement> {
...
export type ChangelogWithNonDestructiveOperations<StatementType extends Statement = Statement> = ChangelogNonDestructiveOperations<StatementType> & ChangelogAppliableToDocument;
export type ChangelogWithDestructiveOperations<StatementType extends Statement = Statement> = ChangelogNonDestructiveOperations<StatementType> & ChangelogDestructiveOperations<StatementType> & ChangelogAppliableToDocument;
export type Changelog<StatementType extends Statement = Statement> = ChangelogWithDestructiveOperations<StatementType>;
