...
export declare function DocumentWithChangelogMixin<TBase extends DocumentWritableConstructor<any, any>>(Base: TBase): {
    new (...args: any[]): {
        ...
        createStatement(about: string, property: string, value: string, datatype?: string, language?: string): ThisType<any>;
        getChangelog(): Changelog;
        addStatement(other: import("../core/Document").Statement): ThisType<any>;
        addStatementAll(others: Iterable<import("../core/Document").Statement>): ThisType<any>;
        createStatementAboutSelf(value: string, property: string, datatype?: string | undefined, language?: string | undefined): ThisType<any>;
        addStatementAboutSelf(other: import("../core/Document").Statement): ThisType<any>;
        addStatementAboutSelfAll(others: Iterable<import("../core/Document").Statement>): ThisType<any>;
        deleteStatement(statement: import("../core/Document").Statement): ThisType<any>;
        pop(): any;
        reverse(): void;
        shift(): any;
