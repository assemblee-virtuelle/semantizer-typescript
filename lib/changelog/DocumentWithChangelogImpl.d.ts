...
export declare function DocumentWithChangelogMixin<TBase extends DocumentWithDestructiveOperationsConstructor<any, any>>(Base: TBase): {
    new (...args: any[]): {
        ...
        getStatementAll(about: string | Resource, property?: string | undefined, language?: string | undefined): (Resource & import("../core/Common").Copyable & import("../core/Statement").StatementNonDestructiveOperations & import("../core/Statement").StatementDestructiveOperations)[];
        getStatementAboutSelf(property: string, language?: string | undefined): (Resource & import("../core/Common").Copyable & import("../core/Statement").StatementNonDestructiveOperations & import("../core/Statement").StatementDestructiveOperations) | undefined;
        getStatementAboutSelfAll(property?: string | undefined, language?: string | undefined): (Resource & import("../core/Common").Copyable & import("../core/Statement").StatementNonDestructiveOperations & import("../core/Statement").StatementDestructiveOperations)[];
        ...
        filterContainedStatement(predicate: (value: Resource & import("../core/Common").Copyable & import("../core/Statement").StatementNonDestructiveOperations & import("../core/Statement").StatementDestructiveOperations, index?: number | undefined, array?: (Resource & import("../core/Common").Copyable & import("../core/Statement").StatementNonDestructiveOperations & import("../core/Statement").StatementDestructiveOperations)[] | undefined) => boolean): (Resource & import("../core/Common").Copyable & import("../core/Statement").StatementNonDestructiveOperations & import("../core/Statement").StatementDestructiveOperations)[];
        ...
        forEachStatement(callbackfn: (value: Resource & import("../core/Common").Copyable & import("../core/Statement").StatementNonDestructiveOperations & import("../core/Statement").StatementDestructiveOperations, index?: number | undefined, array?: (Resource & import("../core/Common").Copyable & import("../core/Statement").StatementNonDestructiveOperations & import("../core/Statement").StatementDestructiveOperations)[] | undefined) => void, thisArg?: any): void;
        ...
        addStatementAboutSelf(other: import("../core/Statement").StatementWithDestructiveOperations): Resource & import("../core/Common").Copyable & import("../core/Statement").StatementNonDestructiveOperations & import("../core/Statement").StatementDestructiveOperations;
        addStatementAboutSelfAll(others: Iterable<import("../core/Statement").StatementWithDestructiveOperations>): (Resource & import("../core/Common").Copyable & import("../core/Statement").StatementNonDestructiveOperations & import("../core/Statement").StatementDestructiveOperations)[];
        setThing(thing: any, uri?: string | undefined): any;
        setThingAt(index: number, thing: any): any;
        setStatement(about: string | Resource, property: string, value: string, oldValue?: string | undefined, datatype?: string | undefined, language?: string | undefined): Resource & import("../core/Common").Copyable & import("../core/Statement").StatementNonDestructiveOperations & import("../core/Statement").StatementDestructiveOperations;
        setStatementAboutSelf(property: string, value: string, oldValue?: string | undefined, datatype?: string | undefined, language?: string | undefined): Resource & import("../core/Common").Copyable & import("../core/Statement").StatementNonDestructiveOperations & import("../core/Statement").StatementDestructiveOperations;
