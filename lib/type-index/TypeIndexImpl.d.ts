...
export declare function TypeIndexMixin<TBase extends DocumentWritableConstructor<TypeIndexRegistration, ThingWritable<TypeIndexStatement>>>(Base: TBase): {
    new (...args: any[]): {
        ...
        createStatement(about: string | TypeIndexRegistration, property: string, value: string, datatype?: string | undefined, language?: string | undefined): TypeIndexStatement;
        ...
        setStatement(about: string | TypeIndexRegistration, property: string, value: string, oldValue?: string | undefined, datatype?: string | undefined, language?: string | undefined): TypeIndexStatement;
        ...
        getStatement(about: string | import("../core/Thing").Thing<import("../core/Statement").Statement>, property: string, language?: string | undefined): TypeIndexStatement | undefined;
        getStatementAll(about: string | import("../core/Thing").Thing<import("../core/Statement").Statement>, property?: string | undefined, language?: string | undefined): TypeIndexStatement[];
