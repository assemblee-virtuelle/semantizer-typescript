...
export class TypeIndexFactory {
    static createTypeIndex(DocumentImpl, ContainedThingImpl, SelfDescribingThingImpl, StatementImpl) {
        ...
        return new TypeIndexImpl(TypeIndexRegistrationImpl, SelfDescribingThingImpl);
    }
}
