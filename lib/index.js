...
const typeIndexDocument = new TypeIndexImpl(new DocumentImpl);
...
const typeIndexLocal = new TypeIndexLocalImpl(new DocumentLocalImpl(new DocumentWithChangelogImpl(new DocumentImpl)));
