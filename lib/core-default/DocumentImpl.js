...
export class DocumentImpl {
    ...
    setStatement(about, property, value, oldValue, datatype, language) {
        throw new Error("Method not implemented.");
    }
    setStatementAboutSelf(property, value, oldValue, datatype, language) {
        throw new Error("Method not implemented.");
    }
    setThing(thing, uri) {
    ...
    setThingAt(index, thing) {
        return this.splice(index, 1, thing)[0]; // Warning here!
    }
    removeThing(thingOrUri) {
        throw new Error("Method not implemented.");
    }
    removeStatement(...params) {
    ...
    splice(start, deleteCount, ...items) {
        ...
        if (deleteCount && items) {
            items.forEach(item => internalItems.push(item.toCopy()));
            this.getContainedThingsInternal().splice(start, deleteCount, ...internalItems);
        }
        else
            this.getContainedThingsInternal().splice(start, deleteCount);
    ...
    getThingAboutSelf() {
        var _a;
        return (_a = this.getSelfDescribingThingInternal()) === null || _a === void 0 ? void 0 : _a.toCopy();
    }
    hasThing(about) {
        throw new Error("Method not implemented.");
    }
